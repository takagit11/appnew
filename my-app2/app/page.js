...
export default function Home() {
  return (
    <div
      ...
      bg-gradient-to-br from-gray-50 to-gray-200 dark:from-gray-800 dark:to-black"
    >
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <ol className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2">
            ...
            <code
              className="bg-black/[.05] dark:bg-white/[.08] 
              px-2 py-1 rounded font-semibold transition-colors hover:bg-black/[.1] dark:hover:bg-white/[.2]"
            >
              app/page.js
            </code>
            .
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            gap-2 hover:bg-[#3a3a3a] dark:hover:bg-[#ccc] 
            text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-6 shadow-md"
          ...
          <a
            className="rounded-full border border-solid border-black/[.08] dark:border-white/[.15] 
            transition-all duration-300 ease-in-out flex items-center 
            justify-center hover:bg-gray-100 dark:hover:bg-gray-700 
            hover:border-transparent text-sm sm:text-base 
            h-10 sm:h-12 px-4 sm:px-6 sm:min-w-44 shadow-md"
